...
By downloading, installing, accessing, or using the Chamate mobile application ("the App"), you agree to be bound by these Terms of Use ("Terms"). If you do not agree to these Terms, please do not use the App.

## 2. Description of Service

Chamate is an AI-powered mobile application that provides:

- Voice-based conversation features
- Speech recognition and audio processing tools
...
- Users must be at least 13 years old to create an account independently
- Children under 13 may use the App with verifiable parental consent in compliance with COPPA
- Users under 18 must have parental or guardian permission to use the App
...
- General app functionality and features
...
## 6. Audio Data and Microphone Usage

### Permission Requirements

- The App requires microphone access for core functionality
- You consent to audio processing as described in our Privacy Policy
- You may revoke microphone permission, though this may limit functionality

### Acceptable Audio Content

- General conversations and interactions
- Voice-based communication
- Appropriate questions and interactions with the AI
...
- Chamate and all related trademarks are owned by Neurakind
- The App, including its design, functionality, and content, is protected by copyright and other intellectual property laws
- All AI-generated responses and content remain our property

### Your Rights

- You retain ownership of your personal data and content you create
...
- **Gemini Vertex AI** for speech recognition and AI processing
...
- The App is designed for general communication and interaction purposes
...
- Report technical issues through the app or email
...
- Disputes will be resolved in accordance with applicable jurisdiction

### Resolution Process

1. Contact our support team first for issue resolution
...
- Do not rely on the App for critical decision-making
...
- **Company:** Neurakind
- **Email:** support@neurakind.com
- **Privacy Policy:** Available within the app and on our website

_These Terms of Use are effective as of the date listed above and apply to all users of the Chamate mobile application. By using the App, you acknowledge that you have read, understood, and agree to be bound by these Terms._
